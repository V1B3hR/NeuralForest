...
class PerformanceBenchmark:
    ...
    def benchmark_memory(self, input_dim: int, batch_size: int = 32) -> BenchmarkResults:
        """
        ...
        mulch_memory = len(self.forest.mulch) * input_dim * 4 / (1024 ** 2)  # Rough estimate
    ...
    def run_full_benchmark(
        ...
        if test_function:
            results['accuracy'] = self.benchmark_accuracy(test_function, num_samples=100, input_dim=input_dim)
