...
from groves.base_grove import Grove, SpecialistTree
...
def demo_multi_grove_system():
    ...
    for modality, grove in groves.items():
        ...
        print(f"  {modality} grove: output shape {output.shape}, "
...
def demo_specialist_planting():
    ...
    new_specializations = ["speaker_recognition", "music_classification", "sound_event_detection"]
