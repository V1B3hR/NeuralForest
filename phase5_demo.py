...
def demo_vision_tasks():
    ...
    # Object Detection
    print("\nb) Object Detection")
    detector = vision.ObjectDetection(
        input_dim=512,
        num_classes=80
    )
    ...
    print(f"  ✓ Detection head working")
    ...
    print(f"  ✓ Segmentation head working")
    print()
...
def demo_audio_tasks():
    ...
    speech_rec = audio.SpeechRecognition(
        input_dim=512,
        vocab_size=100,
        max_length=50
    )
    ...
    print(f"  ✓ Speech recognition head working")
    
    # Audio Classification
    print("\nb) Audio Classification")
    audio_clf = audio.AudioClassification(
        input_dim=512,
        num_classes=10
    )
    ...
    print(f"  ✓ Audio classification head working")
    print()
...
def demo_text_tasks():
    ...
    text_clf = text.TextClassification(
        input_dim=512,
        num_classes=3
    )
    ...
    print(f"  ✓ Text classification head working")
    
    # Named Entity Recognition
    print("\nb) Named Entity Recognition (NER)")
    ner = text.NamedEntityRecognition(
        input_dim=512,
        num_entity_types=6,
        max_length=128
    )
    ...
    print(f"  ✓ NER head working")
    
    # Text Generation
    print("\nc) Text Generation / Summarization")
    text_gen = text.TextGeneration(
        input_dim=512,
        vocab_size=30000,
        max_length=100
    )
    ...
    print(f"  ✓ Text generation head working")
    print()
...
def demo_video_tasks():
    ...
    video_clf = video.VideoClassification(
        input_dim=512,
        num_classes=400
    )
    ...
    print(f"  ✓ Video classification head working")
    
    # Action Recognition
    print("\nb) Action Recognition")
    action_rec = video.ActionRecognition(
        input_dim=512,
        num_actions=100
    )
    ...
    print(f"  ✓ Action recognition head working")
    print()
...
def demo_cross_modal_tasks():
    ...
    img_text_match = cross_modal.ImageTextMatching(
        input_dim=512
    )
    ...
    print(f"  ✓ Image-text matching head working")
    ...
    print(f"  ✓ Image captioning head working")
    
    # Audio-Visual Correspondence
    print("\nc) Audio-Visual Correspondence")
    av_corr = cross_modal.AudioVisualCorrespondence(
        input_dim=512
    )
    ...
    print(f"  ✓ Audio-visual correspondence head working")
    print()
