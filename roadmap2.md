...
## Phase 2: The Ecosystem — Forest Simulation
...
- **ForestEcosystem**: Class managing the population of trees (TreeExpert), data sampling (anchors, mulch)
- **Competition Rules**: Rivalry for "nutrients" (data batches), pruning of the weakest trees, planting the strongest architectures
- **Robustness Tests**: Introducing random disruptions (“drought”, “flood” in data) and observing which architectures survive
- **Statistics Logging**: Ongoing: fitness, generations count, architecture/size distribution, selection rate
