...
class ClassificationHead(TaskHead):
    ...
    def __init__(self, input_dim: int, num_classes: int, task_name: str = "classification"):
...
class SegmentationHead(TaskHead):
    ...
    def __init__(self, input_dim: int, num_classes: int, task_name: str = "segmentation"):
        super().__init__(input_dim, task_name)
        self.num_classes = num_classes
...
class RegressionHead(TaskHead):
    ...
    def __init__(self, input_dim: int, output_dim: int = 1, task_name: str = "regression"):
        super().__init__(input_dim, task_name)
...
class GenerationHead(TaskHead):
    ...
    def __init__(self, input_dim: int, vocab_size: int, max_length: int = 50, 
...
class TaskRegistry:
    ...
    @classmethod
    def create_head(cls, task_name: str, input_dim: int, **kwargs) -> Optional[TaskHead]:
        """
